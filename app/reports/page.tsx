                ...
                <div className="p-6 max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                        <div className="bg-white p-4 rounded-lg shadow-sm border border-purple-100">
                            <h3 className="text-sm font-bold text-black">Total Cases</h3>
                            <p className="text-3xl font-bold text-purple-600">{totalCases}</p>
                        </div>
                        <div className="bg-white p-4 rounded-lg shadow-sm border border-green-100">
                            <h3 className="text-sm font-bold text-black">Approved</h3>
                        ...
                        <div className="bg-white p-4 rounded-lg shadow-sm border border-yellow-100">
                            <h3 className="text-sm font-bold text-black">In Verification</h3>
                            <p className="text-3xl font-bold text-yellow-600">{statusCounts['VERIFICATION'] || 0}</p>
                        </div>
                        <div className="bg-white p-4 rounded-lg shadow-sm border border-red-100">
                            <h3 className="text-sm font-bold text-black">Pending Docs</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-3">
                                {Object.entries(statusCounts).map(([status, count]) => (
                                    <div key={status} className="flex items-center justify-between">
                                        <span className="text-sm text-black font-medium bg-gray-100 px-2 py-1 rounded border border-gray-300">{status.replace('_', ' ')}</span>
                        ...
                        {/* User Workload */}
                        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                            <h2 className="text-lg font-bold text-black mb-4">User Workload</h2>
                            <div className="space-y-3">

        ...
        <AnimatePresence>
            {isOpen && (
                <div className="fixed inset-0 z-[100] overflow-hidden" role="dialog" aria-modal="true">
                    ...
                    >
                        {/* Header - Fixed */}
                        <div className="bg-gradient-to-r from-purple-600 via-purple-700 to-indigo-700 px-8 py-5 shadow-xl">
                            <div className="max-w-[1800px] mx-auto flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h1 className="text-2xl font-bold text-white tracking-tight">Forward To Process</h1>
                                        <p className="text-purple-200 text-sm mt-0.5">Complete the form to create a new case</p>
                                    </div>
                                </div>
                                <button
                                    onClick={onClose}
                        ...
                        <div className="flex-1 overflow-y-auto bg-gray-50">
                            <form onSubmit={(e) => e.preventDefault()} className="max-w-[1800px] mx-auto px-8 py-6">
                                {currentStep === 1 ? (
                                    <>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                                ...
                                                <div>
                                                    ...
                                                    <select
                                                        ...
                                                        className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-gray-900 bg-white transition-all"
                                                    >
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-gray-900 bg-white transition-all"
                                                    />
                                                    <p className="text-xs text-gray-400 mt-1">First letter auto-capitalized</p>
                                                </div>
                                        ...
                                        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-6">
                                            <div className="flex items-center justify-between mb-6">
                                                ...
                                                <button
                                                    ...
                                                    className="flex items-center gap-2 px-4 py-2 text-purple-600 hover:text-purple-700 hover:bg-purple-50 rounded-xl transition-all font-medium text-sm"
                                                >
                                                    ...
                                                    <div key={idx} className="bg-gray-50 rounded-xl border border-gray-200 p-5">
                                                        ...
                                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                            <input
                                                                ...
                                                                className="px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-gray-900 bg-white text-sm"
                                                            />
                                                            <input
                                                                type="tel"
                                    ...
                                    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 mb-6">
                                        <div className="flex items-center gap-3 mb-8 border-b pb-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-500">Please review the details before creating the case</p>
                                            </div>
                                        </div>
                                        ...
                                        <dl className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
                                            <div>
                                                ...
                                                <dd className="mt-1 text-lg font-medium text-gray-900">{formData.policyType}</dd>
                                            </div>
                                            <div>
                                                <dt className="text-sm font-medium text-gray-500">Case Type</dt>
                                                <dd className="mt-1 text-lg font-medium text-gray-900">{formData.caseType}</dd>
                                            </div>
                                            <div className="md:col-span-2">
                                                <dt className="text-sm font-medium text-gray-500 mb-2">Benefit Types</dt>
                                                <dd className="flex flex-wrap gap-2">
                                                    {formData.benefitTypes.map((b, i) => (
                                                        <span key={i} className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium">{b}</span>
                                                    ))}
                                                    {formData.benefitTypes.length === 0 && <span className="text-gray-400 italic">None selected</span>}
                                                </dd>
                                            </div>
                                            ...
                                            <div className="md:col-span-2 border-t pt-6">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                    <div>
                                                        ...
                                                        <dd className="mt-1 text-lg font-medium text-gray-900">{formData.companyName}</dd>
                                                    </div>
                                                    <div>
                                                        <dt className="text-sm font-medium text-gray-500">Company Type</dt>
                                                        <dd className="mt-1 text-lg font-medium text-gray-900">{formData.companyType}</dd>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div className="space-y-3">
                                                    {formData.contacts.map((contact, i) => (
                                                        <div key={i} className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-100">
                                                            <div className="flex items-center gap-3">
                                                                <span className="w-6 h-6 flex items-center justify-center bg-purple-600 text-white rounded-full text-xs font-bold">{i + 1}</span>
                                                                <div>
                                                                    <div className="font-medium text-gray-900">{contact.name}</div>
                                                                    <div className="text-sm text-gray-500">{contact.designation === 'Other' ? contact.customDesignation : contact.designation}</div>
                                                                </div>
                                                            </div>
                                                            <div className="mt-2 sm:mt-0 font-medium text-gray-700 font-mono text-sm ml-9 sm:ml-0">
                                                                {contact.phoneNumber}
                                                            </div>
                                                        </div>
                                                    ))}
                                ...
                                {/* Footer Actions */}
                                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 sticky bottom-0 z-10">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-4">
                                            ...
                                            {showDraftSaved && (
                                                <span className="text-green-600 text-sm font-bold flex items-center gap-1 bg-green-50 px-3 py-1.5 rounded-lg border border-green-100 shadow-sm animate-pulse">
                                                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                                    </svg>
                                                    Draft Saved
                                            ...
                                            {currentStep === 1 ? (
                                                <>
                                                    ...
                                                    <button
                                                        ...
                                                        className="px-5 py-2.5 text-purple-700 font-medium bg-purple-50 hover:bg-purple-100 border border-purple-200 rounded-xl transition-colors flex items-center gap-2"
                                                    >
                                                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    ...
                                                    <button
                                                        ...
                                                        className="px-8 py-2.5 text-white font-semibold bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 rounded-xl shadow-lg shadow-purple-500/25 transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none flex items-center gap-2"
                                                    >
                                                        Next Page
                                                        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                ...
                                                <>
                                                    <button
                                                        type="button"
                                                        onClick={handleBack}
                                                        className="px-6 py-2.5 text-gray-700 font-medium bg-white border border-gray-300 hover:bg-gray-50 rounded-xl transition-colors flex items-center gap-2"
                                                    >
                                                        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    ...
                                                    <button
                                                        ...
                                                        className="px-8 py-2.5 text-white font-semibold bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 rounded-xl shadow-lg shadow-purple-500/25 transition-all flex items-center gap-2"
                                                    >
                                                        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
